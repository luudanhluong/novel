...
const FormRate = ({ sid, onchangeRateNo }) => {
    ...
    return (
        <div id="rating">
            <input onChange={(e) => handleOnchageRate(e)} onClick={(e) => handleOnclickRate(e)} checked={results === 5 ? true : false} type="radio" id="star5" name="rating" value="5" />
            <label class="full" htmlFor="star5" title="Awesome - 5 stars"></label>

            <input onChange={(e) => handleOnchageRate(e)} onClick={(e) => handleOnclickRate(e)} checked={results === 4 ? true : false} type="radio" id="star4" name="rating" value="4" />
            <label class="full" htmlFor="star4" title="Pretty good - 4 stars"></label>

            <input onChange={(e) => handleOnchageRate(e)} onClick={(e) => handleOnclickRate(e)} checked={results === 3 ? true : false} type="radio" id="star3" name="rating" value="3" />
            <label class="full" htmlFor="star3" title="Meh - 3 stars"></label>

            <input onChange={(e) => handleOnchageRate(e)} onClick={(e) => handleOnclickRate(e)} checked={results === 2 ? true : false} type="radio" id="star2" name="rating" value="2" />
            <label class="full" htmlFor="star2" title="Kinda bad - 2 stars"></label>

            <input onChange={(e) => handleOnchageRate(e)} onClick={(e) => handleOnclickRate(e)} checked={results === 1 ? true : false} type="radio" id="star1" name="rating" value="1" />
