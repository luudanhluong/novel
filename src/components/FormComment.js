        ...
        <Row className="pb-5 mb-5">
            ...
            <Col xs={12}>
                <Row className="d-flex justify-content-center">
                    ...
                    <Col xs={2}>
                        <Button onClick={() => handleSend()} className="px-4">Gửi</Button>
                    </Col>
                </Row>
            </Col>
            <Col xs={12}>
                <ul className="list-unstyled m-0 mt-4 p-0 ps-5">
                    {
                        newComment.map((c) => (
                            <li key={c.id}>
                                <Row>
                                    <Col xs={1}>
                                        <img className="rounded-5 border mw-100" src={`${typeof c.img === "undefined" ? "https://cdn.landesa.org/wp-content/uploads/default-user-image.png" : c.img}`} alt={c.username} />
                                    </Col>
                                    <Col xs={11}>
                                        <Row>
                                            <Col xs={11}>
                                                <Row className={"bg-grey pt-1 pb-2 rounded-4"}>
                                                    ...
                                                    <Col xs={12}>
                                                        {
                                                            editNo === c.id ? "" : (<p className="m-0 lh-sm text-break" ref={commentValue}>{c.comment}</p>)
                                                        }
                                                        {
                                                            editNo === c.id ?
                                                                (
                                                                    <Row>
                                                                        ...
                                                                        <Col xs={2}>
                                                                            <Button onClick={() => handleEdit(c)} className="px-4">Gửi</Button>
                                                                        </Col>
                                                                    </Row>
                                                                ) : ""
                                                        }
                                            ...
                                            <Col xs={12}>
                                                <ul className="list-unstyled m-0 mt-1 mb-1 p-0 d-flex">
                                                    <li onClick={() => setReplyNo(c.id)} className="fs-10 text-info me-1 ms-1 custom-cursor">Trả lời</li>
                                                    {
                                                        user === null || user.id !== c.userId ?
                                                            (
                                                                ...
                                                                (
                                                                    <>
                                                                        <li onClick={() => handleDelete(c.id)} className="fs-10 text-info me-1 ms-1 custom-cursor">Xóa</li>
                                                                        <li onClick={() => handleEditComment(c)} className="fs-10 text-info me-1 ms-1 custom-cursor">Chỉnh sửa</li>
                                                                    </>
                                                                ) : ""
                                                    }
                                                    <li className="color_grey fs-10 ms-1">{CalTime(c.date)}</li>
                                                </ul>
                                                {
                                                    replyNo === c.id ?
                                                        (
                                                            <Row>
                                                                ...
                                                                <Col xs={2}>
                                                                    <Button onClick={() => handleReply(c)} className="px-4">Gửi</Button>
                                                                </Col>
                                                            </Row>
                                                        ) : ""
                                                }
                                                                            ...
                                                                            <Col xs={11}>
                                                                                <Row>
                                                                                    <Col xs={11}>
                                                                                        <Row className={"bg-grey pt-1 pb-2 rounded-4"}>
                                                                                            <Col xs={12}>
                                                                                                <p className="lh-sm m-0 fw-bold">{reply.userName}</p>
                                                                                            </Col>
                                                                                            <Col xs={12}>
                                                                                                {
                                                                                                    editReplyNo === reply.id ? "" : (<p className="m-0 lh-sm text-break" ref={commentReplyValue}>{reply.reply}</p>)
                                                                                                }
                                                                                                {
                                                                                                    editReplyNo === reply.id ?
                                                                                                        (
                                                                                                            <Row>
                                                                                                                <Col xs={9}>
                                                                                                                    <Form.Group>
                                                                                                                ...
                                                                                                                <Col xs={2}>
                                                                                                                    <Button onClick={() => handleEditReply(reply)} className="px-4">Gửi</Button>
                                                                                                                </Col>
                                                                                                            </Row>
                                                                                                        ) : ""
                                                                                                }
                                                                                        ...
                                                                                        <ul className="list-unstyled m-0 mt-1 p-0 mb-1 d-flex">
                                                                                            {
                                                                                                user === null || user.id !== reply.userId ?
                                                                                                    (
                                                                                                        ...
                                                                                                        (
                                                                                                            <>
                                                                                                                <li onClick={() => handleDeleteReply(reply.id)} className="fs-10 text-info me-1 ms-1 custom-cursor">Xóa</li>
                                                                                                                <li onClick={() => handleEditCommentReply(reply.id)} className="fs-10 text-info me-1 ms-1 custom-cursor">Chỉnh sửa</li>
                                                                                                            </>
                                                                                                        ) : ""

                                                                                            }
                                                                                            <li className="color_grey fs-10 ms-1">{CalTime(reply.date)}</li>
                                                                                        </ul>
                                                                                    </Col>
                                                                                </Row>
                                                                            </Col>
